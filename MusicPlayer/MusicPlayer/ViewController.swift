...
//  MusicPlayer
//
//  Created by Goun Choi on 2019/10/29
//  Copyright © 2019 Goun Choi. All rights reserved.
//
...
class ViewController: UIViewController, AVAudioPlayerDelegate{
    ...
    //MARK: IBOutlet -> to show on the storyboard
    ...
    func makeAndFireTimer(){
        self.timer = Timer.scheduledTimer(withTimeInterval: 0.01, repeats: true, block: { [unowned self] (timer: Timer)
            in
